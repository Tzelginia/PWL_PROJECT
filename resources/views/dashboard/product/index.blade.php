                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="/dashboardproduct" class="btn btn-sm btn-primary">
                                Tambah Produk
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($product as $p)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="wrapper">
                                                    <img src="{{ url('img' . '/' . $p->file_pendukung) }}" alt=""
                                                        class="rounded mx-auto d-block" width="100%" height="100%">
                                                </div>
                                            </td>
                                            <td>
                                                <a href="#" class="badge bg-info"><span
                                                        class="menu-icon mdi mdi-eye"></span></a>
                                                <a href="#" class="badge bg-warning"><span
                                                        class="menu-icon mdi mdi-circle-edit-outline"></span></a>
